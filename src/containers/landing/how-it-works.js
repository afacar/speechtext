    ...
    render() {
        return (
            <div className='how-it-works-content'>
                <Row className="mb-5 mt-5">
                    <Col lg="12">
                        ...
                        <Row className='steps-container'>
                            ...
                            <Col lg='4' md='4' sm='12' xs='12' className='clickable' onClick={ this.handleStepClick }>
                        ...
                        <Row className='steps-container'>
                            ...
                            <Col lg="4" mb="4" sm='12' xs='12' className='clickable' onClick={ this.handleStepClick }>
                                <Card className="h-100 text-center">
                ...
                <Auth language={ this.props.language } show={ this.state.showAuth } handleClose={ () => this.setState({ showAuth: false }) } />
            </div>
        )
    }
}
